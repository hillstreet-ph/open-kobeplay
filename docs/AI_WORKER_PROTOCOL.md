...
Before changing `open-kobeplay`, read its local `AGENTS.md`, README, contribution guide, workflows, migrations, open issues, and open pull requests. Local repository instructions take precedence when they are more specific.
